...
class Blockchain:
    ...
    def create_genesis_block(self):
        ...
        a valid hash.
        """
        genesis_block = Block(0, [], dict, 0, sha256("0".encode()).hexdigest())
    ...
    def mine(self):
        ...
        new_block = Block(height=last_block.height + 1,
                          ...
                          cumulated=dict(functools.reduce(operator.add, map(
                              collections.Counter, self.unconfirmed_transactions+last_block.cumulated
                          ))),
                          timestamp=time.time(),
